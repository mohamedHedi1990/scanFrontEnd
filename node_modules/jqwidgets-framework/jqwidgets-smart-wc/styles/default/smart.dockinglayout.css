...
:host(smart-docking-layout) > .smart-container {
    overflow: hidden;
}
...
.smart-docking-layout smart-tabs-window.smart-window:not(.smart-docking-layout-auto-hide-window) > .smart-container > .smart-header-section,
.smart-docking-layout smart-tabs-window.smart-window[pinned]:not(.smart-docking-layout-auto-hide-window) > .smart-container > .smart-header-section,
.smart-docking-layout .smart-docking-layout-auto-hide-window.smart-window > .smart-container:not([class*="smart-window-resizing"]) > .smart-header-section {
    cursor: pointer;
...
.smart-docking-layout .smart-window > .smart-container > .smart-content {
    align-items: stretch;
}
...
.smart-docking-layout smart-tabs-window.smart-window {
    ...
    .smart-docking-layout smart-tabs-window.smart-window:not([animation='none']) {
...
.smart-docking-layout smart-splitter-item smart-tabs-window.smart-window[auto-hide] > .smart-container > .smart-content {
    height: 100%;
}
...
smart-tabs-window.smart-window[tabs-window-dragged] > .smart-container > .smart-header-section,
.smart-docking-layout .smart-docking-layout-auto-hide-window[opened] > .smart-container > .smart-header-section {
}
...
.smart-docking-snap-bottom-feedback {
    ...
    position: absolute;
    opacity: 0.65;
    box-shadow: 0 0 1px 1px var(--smart-dokcing-layout-feedback-border-color);
    border-radius: 2px;
...
.smart-docking-layout smart-tabs-window.smart-window {
    ...
    .smart-docking-layout smart-tabs-window.smart-window[auto-hide] {
        ...
        .smart-docking-layout smart-tabs-window.smart-window[auto-hide] .smart-container > .smart-content {
            padding: 0;
        }
...
.smart-docking-layout .smart-placeholder .smart-window > .smart-container > .smart-header-section {
    min-height: 0;
    height: 0;
    padding: 0;
}
