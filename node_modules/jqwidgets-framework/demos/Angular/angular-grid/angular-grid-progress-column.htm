...
<html>
    ...
    <head>
        <title id='Description'>Angular 8 Grid Progress Column</title>
        <base href="./../dist/grid/progress-column/">
        <meta name="description" content="This is an example of Angular 8 Grid's progress column feature." />
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="example-description">
            This example illustrates the progress column Grid feature for Angular.
        </div>
