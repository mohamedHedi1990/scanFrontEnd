...
<html>
    ...
    <head>
        ...
        <base href="./../dist/grid/rating-column/">
        <meta name="description" content="This is an example of Angular 8 Grid's rating column feature." />
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="example-description">
            This example illustrates the rating column Grid feature for Angular.
        </div>
