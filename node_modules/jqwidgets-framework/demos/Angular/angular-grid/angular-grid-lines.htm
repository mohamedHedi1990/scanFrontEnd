...
<html>
    ...
    <head>
        <title id='Description'>Angular 8 Grid Lines Config</title>
        <base href="./../dist/grid/lines/">
        <meta name="description" content="This is an example of Angular 8 Grid's charting feature." />
        <meta charset="UTF-8">
    ...
    <body>
		...
		In this example, the lines of the Grid are configurable. You can display only the vertical lines or the horizontal lines depending on your preference.
		</div>
