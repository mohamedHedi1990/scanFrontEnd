...
<html>
    ...
    <head>
        <title id='Description'>Angular 8 Grid Multi Columns Sort</title>
        <base href="./../dist/grid/sortingmany/">
        <meta name="description" content="This is an example of Angular 8 Grid's Multi Columns Sort." />
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="example-description">
            This example illustrates the Angular 8 Grid sorting by multiple columns feature.
        </div>
