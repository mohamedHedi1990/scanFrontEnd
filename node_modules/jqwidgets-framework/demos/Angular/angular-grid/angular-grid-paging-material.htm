...
<html>
    ...
    <head>
        <title id='Description'>Angular 8 Grid Paging Material</title>
        <base href="./../dist/grid/paging-material/">
        <meta name="description" content="This is an example of Angular 8 Grid's paging material mode feature." />
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div class="example-description">
            This example illustrates the Material Pager of the DataGrid component for Angular.
        </div>
